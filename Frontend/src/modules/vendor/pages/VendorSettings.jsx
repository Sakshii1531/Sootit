  ...
  return (
    <div className="bg-neutral-50 min-h-screen pb-24 font-inter">
      <div className="bg-white px-6 pt-10 pb-8 flex items-center gap-5 border-b border-slate-100 sticky top-0 z-10">
         <div className="h-16 w-16 bg-[#C44545] rounded-[1.8rem] flex items-center justify-center text-white font-black text-xl shadow-2xl shadow-[#C44545]/20">
            SG
         </div>
         <div className="flex flex-col">
            <h1 className="text-xl font-black tracking-tighter leading-none mb-1.5 uppercase">Sharma Garage</h1>
            <span className="text-[12px] font-bold text-slate-400 uppercase tracking-widest">ID: VND-48201A</span>
            <div className="flex items-center gap-1.5 mt-2 bg-rose-50 w-auto self-start px-2 py-1 rounded-lg text-[12px] font-black uppercase text-[#C44545] border border-rose-100 shadow-sm">
               <Shield size={10} className="fill-[#C44545]" /> KYC Verified
            </div>
         </div>
      </div>
      ...
      <div className="px-6 py-8 space-y-10">
         <section>
            <h3 className="text-[14px] font-black uppercase text-neutral-700 tracking-[0.25em] mb-5 pl-1">Management Console</h3>
         ...
         <section>
            <h3 className="text-[14px] font-black uppercase text-neutral-700 tracking-[0.25em] mb-5 pl-1">Configuration</h3>
            <div className="bg-white border text-sm font-bold border-slate-200 rounded-[2.5rem] overflow-hidden shadow-xl shadow-black/[0.01]">
